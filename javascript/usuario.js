...
function identificarUsuario(userId, userlogId) {
  usuariodao.buscar(userId).then(function(usuario){
    ...
    if(userId === userlogId){
      ...
      <p> - </p>
      <a class="ml-1" href="mailto:ecim@gmail.com?subject=Assunto do email&amp;body=Olá,%0D%0A%0D%0A[corpo do email]%0D%0A%0D%0AAtenciosamente,%0D%0A${usuarioAtual.getNome()}">Fale conosco</a>
      </small>`
    }
